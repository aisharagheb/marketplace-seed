    ...
    $stateProvider
        .state('cart', {
            ...
            resolve: {
                ...
                PromotionsList: function(OrderCloud, CurrentOrder) {
...
function CartController($q, $rootScope, $timeout, OrderCloud, LineItemHelpers, CurrentOrder, LineItemsList, PromotionsList) {
    var vm = this;
